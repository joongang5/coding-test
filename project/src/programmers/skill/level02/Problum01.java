package programmers.skill.level02;
...
public class Problum01 {
	...
	public int solution(int N, int[][] road, int K) {
        ...
        HashMap<Integer, TownInfo> map = new HashMap<Integer, TownInfo>();  
        ...
        for (int i = 0; i < road.length; i++) {
			...
			if (map.containsKey(town1)) {
				townInfo = map.get(town1);
			}
			else {
				townInfo = new TownInfo();
			}

			townInfo.startNum = town1;
		}
...
class TownInfo {
	public int startNum;
	ArrayList<RoadInfo> roadInfos = new ArrayList<RoadInfo>();
}
...
class RoadInfo {
	...
	public RoadInfo(int destNum, int distance) {
