...
도로를 이용하여 이동할 때 1km마다 1리터의 기름을 사용한다. 각 도시에는 단 하나의 주유소가 있으며, 
도시 마다 주유소의 리터당 가격은 다를 수 있다. 가격의 단위는 원을 사용한다.
...
public class P13305 {
	...
	public static void main(String[] args) {
		...
		long payment = Integer.MAX_VALUE;
		for (int i = 0; i < distances.length; i++) {
			if (prices[i] < payment) {
				payment = prices[i];
			}
				
			answer += payment * distances[i];
		}
